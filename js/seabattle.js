...
function SeaBattle(targetContainer, edge) {
    ...
    /**
     *@var possibeDiections Список сторон, на которых можно расположить корабль
     */
    var possibleDirections = ['top', 'bottom', 'right', 'left'];

    /**
     *@var getPlayerNameInputHtml Получаем html-текст поля ввода с именем игрока
     */
    ...
    /**
     *@var concat cложение строк через разделитель
     */
    ...
    /**
     *@var getSeaArea получаем игровое поле для указанного игрока
     */
    var getSeaArea = function(id, labelValue, inputId, inputDefaultValue, inputTitle, inputPlaceholder, inputAutoFocus) {
        return $('<div>')
            ...
            .append(
                ...
                .html(
                    concat(
                        labelValue, getPlayerNameInputHtml(
                            inputId, inputDefaultValue, inputTitle, inputPlaceholder, inputAutoFocus)
                    )
                )
            )
            .append(
    ...
    /**
     *@var getMessagesArea Получаем поле с сообщениями
     */
    ...
    var getGameContainer = function() {
        ...
        gameContainer
            .append(
                getSeaArea(
                    elementsIds.playerSeaContainer, 'Ваше поле,', elementsIds.playerName, 'Игрок', 'Имя игрока', 'Введите ваше имя', true
                )
            )
            .append(
                getSeaArea(
                    elementsIds.computerSeaContainer, 'Противник', elementsIds.computerName, 'Компьютер', 'Имя компьютера', 'Введите имя компьютера', false
                )
            )
            .append(
                getMessagesArea()
